...
"""Technique 4 / KITTI / base -- evaluation script.
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate Technique 4 KITTI base')
    ...
    with torch.no_grad():
        for batch in test_loader:
            ...
            pred_complex = compute_complex_image(out_depth, out_bb, beta, a_val, unit, image_half, max_depth_m=cfg.kitti_max_depth_m)

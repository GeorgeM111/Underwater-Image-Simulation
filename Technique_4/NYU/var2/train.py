...
def main():
    ...
    for epoch in range(start_epoch, cfg.epochs):
        ...
        for batch in train_loader:
            ...
            total_loss = (w_global[0] * loss_depth + w_global[1] * loss_complex + w_global[2] * loss_haze + w_global[3] * loss_direct)
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                loss_haze = (w_deg[0] * l1(pred_haze, haze) + w_deg[1] * ssim_loss(pred_haze, haze, 1) + w_deg[2] * vgg(pred_haze, haze))
                loss_direct = (w_dir[0] * l1(out_direct, complex_gt) + w_dir[1] * ssim_loss(out_direct, complex_gt, 1) + w_dir[2] * vgg(out_direct, complex_gt))
                v_loss = (w_global[0] * loss_depth + w_global[1] * loss_complex + w_global[2] * loss_haze + w_global[3] * loss_direct)

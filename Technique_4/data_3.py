...
class depthDatasetMemory(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        haze_image_name = r"C:\home\Georges\data\save_data_water\all_data\\" + str(idx) + "haze_image" + ".npy"
        complex_haze_image_name =  r"C:\home\Georges\data\save_data_water\all_data\\" + str(idx) + "complex_haze_image" + ".npy"
...
def getTrainingTestingData(batch_size):
    data, nyu2_train = loadZipToMem(r'C:\home\Georges\data\nyu_data.zip')

    beta_mat_arr = load(r'C:\home\Georges\DenseDepth_1\Beta_Mat.npy')
    a_mat_arr = load(r'C:\home\Georges\DenseDepth_1\A_Mat.npy')
...
def getTestingDataOnly(batch_size):
    data, nyu2_test = loadZipToMemTest(r'C:\home\Georges\DenseDepth_1\nyu_data.zip')

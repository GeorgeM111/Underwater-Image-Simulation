...
def main():
    ...
    writer = SummaryWriter('/homes/t20monda/DenseDepth_3/runs/real_DenseDepth_3_Make_3D_weight_1_running')
    ...
    if train_me_where == "from_middle":
        checkpoint = torch.load('/sanssauvegarde/homes/t20monda/DenseDepth_3/checkpoint/' + model_name + '/Models_Weight_1_Make_3D' + '.ckpt')

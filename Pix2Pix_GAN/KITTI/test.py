...
"""Pix2Pix GAN / KITTI -- evaluation (metrics of generated vs GT degraded image)."""
...
def main():
    parser = argparse.ArgumentParser(description='Pix2Pix GAN eval - KITTI')
    ...
    ckpt_path = args.resume or os.path.join(cfg.checkpoint_dir, 'Pix2Pix_GAN', 'Pix2Pix_KITTI.ckpt')

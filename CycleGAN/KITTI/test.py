...
"""CycleGAN / KITTI -- evaluation (metrics of generated degraded image vs GT)."""
...
def main():
    parser = argparse.ArgumentParser(description='CycleGAN eval - KITTI')
    ...
    ckpt_path = args.resume or os.path.join(cfg.checkpoint_dir, 'CycleGAN', 'CycleGAN_KITTI.ckpt')
    ...
    print('[CycleGAN KITTI] evaluation:')
    for k in keys:

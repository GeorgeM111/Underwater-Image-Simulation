...
def main():
    ...
    for epoch in range(start_epoch, cfg.epochs):
        ...
        for batch in train_loader:
            ...
            total_loss = (w_global[0] * loss_depth + w_global[1] * loss_complex + w_global[2] * loss_haze)
        ...
        with torch.no_grad():
            for batch in val_loader:
                ...
                loss_complex = (1.0 - w_bb[0]) * ssim_loss(pred_complex, complex_gt, 1) + w_bb[0] * l1(pred_complex, complex_gt)
                loss_haze = (1.0 - w_bb[1]) * ssim_loss(pred_haze, haze, 1) + w_bb[1] * l1(pred_haze, haze)
                v_loss = (w_global[0] * loss_depth + w_global[1] * loss_complex + w_global[2] * loss_haze)

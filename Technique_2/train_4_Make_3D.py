...
def main():
    ...
    # torch.save(train_loader, '/sanssauvegarde/homes/t20monda/DenseDepth_2/train_loader_make_3D.pkl')

    # Load data
    train_loader = torch.load('/sanssauvegarde/homes/t20monda/DenseDepth_2/train_loader_make_3D.pkl')
    writer = SummaryWriter('/homes/t20monda/DenseDepth_2/runs/real_DenseDepth_2_Make_3D_running')

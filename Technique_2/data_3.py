...
class depthDatasetMemory(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        haze_image_name = "/users/local/t20monda/all_data/" + str(idx) + "haze_image" + ".npy"
        complex_haze_image_name =  "/users/local/t20monda/all_data/" + str(idx) + "complex_haze_image_name" + ".npy"
...
def getTrainingTestingData(batch_size):
    ...
    beta_mat_arr = load('/homes/t20monda/DenseDepth_2/Beta_Mat.npy')
    a_mat_arr = load('/homes/t20monda/DenseDepth_2/A_Mat.npy')

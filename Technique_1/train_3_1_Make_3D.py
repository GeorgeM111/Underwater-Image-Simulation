   ...
   # Create and save  data
    ...
    if train_me_where == "from_middle":
        checkpoint = torch.load(
            '/sanssauvegarde/homes/t20monda/Dense_Depth_1/checkpoint/' + model_name + '/Models_Make_3D' + '.ckpt')
    ...
    for epoch in range(args.epochs):
        ...
        for i, sample_batched in enumerate(train_loader):
            ...
            running_batch_loss += total_batch_loss.item() * image_full.size(0)  # dividing by number of images in the
            # batch
            ...
            if i == N-1: # save last batch of each epoch

...
def ClacAccuracyOnly(test_loader):
    ...
    for i in range(need_train+1, N):
        ...
        saving_path_complex_imag_GT = '/sanssauvegarde/homes/t20monda/Test_Resources_1/' + 'Batch_%d' % i + '_Complex_Imag_GT' + '.pt'
        saving_path_complex_imag_Pred = '/sanssauvegarde/homes/t20monda/Test_Resources_1/' + 'Batch_%d' % i + '_Complex_Imag_Pred' + '.pt'
...
def LogProgress(test_loader):
    writer = SummaryWriter('/homes/t20monda/DenseDepth_1/runs1/real_densedepth_weight_1_running')

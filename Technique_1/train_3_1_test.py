...
def main():
    ...
    print("I am in Dense-depth 1")
    # If you want to calculate only the trainable parameters:

    pytorch_total_params_1 = sum(p.numel() for p in model_1.parameters() if p.requires_grad)
    pytorch_total_params_2 = sum(p.numel() for p in model_2.parameters() if p.requires_grad)
    print("The number of trainable params for model 1 in dense-depth 1 are: ", pytorch_total_params_1)
    print("The number of trainable params for model 2 in dense-depth 1 are: ", pytorch_total_params_2)
    ...
    # writer_1 = SummaryWriter('/homes/t20monda/DenseDepth_1/runs1/real_DenseDepth_1_running')

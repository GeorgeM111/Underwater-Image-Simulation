...
def ClacAccuracyOnly(test_loader):
    ...
    for i in range(need_train+1, N):
        ...
        saving_path_complex_imag_GT = '/sanssauvegarde/homes/t20monda/Test_Resources/' + 'Batch_%d' % i + '_Complex_Imag_GT' + '.pt'
        saving_path_complex_imag_Pred = '/sanssauvegarde/homes/t20monda/Test_Resources/' + 'Batch_%d' % i + '_Complex_Imag_Pred' + '.pt'
...
def LogProgress(test_loader):
    writer = SummaryWriter('/homes/t20monda/DenseDepth_1/runs1/real_densedepth_running')
    ...
    for i, sample_batched in enumerate(test_loader):
        if cnt_batch > need_train : # to skip the last batch from training  
            ...
            # a2_acc = a2_acc + a2
            # a3_acc = a3_acc + a3
            # abs_rel_acc = abs_rel_acc + abs_rel
            # rmse_acc = rmse_acc + rmse
            # log_10_acc = log_10_acc + log_10
    ...
    # a1_acc = a1_acc / valid_batch_cnt
    # a2_acc = a2_acc / valid_batch_cnt
    # a3_acc = a3_acc / valid_batch_cnt
    # abs_rel_acc = abs_rel_acc / valid_batch_cnt
    # rmse_acc = rmse_acc / valid_batch_cnt
    # log_10_acc = log_10_acc / valid_batch_cnt

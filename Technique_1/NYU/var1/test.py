...
"""Technique 1 / NYU / var1 -- evaluation script.
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate Technique 1 NYU var1')
    ...
    with torch.no_grad():
        for bi, batch in enumerate(test_loader):
            ...
            # var1's models also return their learned loss weights; only the predictions
            # are needed here (the weights never enter a metric).
